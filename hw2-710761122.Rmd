...
```{python ans12}
index_3ticks=[i for i in range(len(filelines)) if filelines[i][0:3] == u'```']
index_3ticks
```
...
```{python ans23}
showInfo_5d35e=search_by_uid('5d35ec95d083a398fcdc5e14')
showInfo_5d35e.append({'time': '2019/10/30 15:00:00', 'location': '新北市三峽區大學路151號', 'locationName': '國立臺北大學'})

updated_result=showInfo_5d35e
updated_result
```
